...
def test_calculate_branch_semester_avg_scores():
    # Sample data with multiple branches per semester
    cleaned_results_by_semester = {
        '100 level Harmattan': [
            {'course': 'ACC101', 'unit': 3, 'branch': 'Accessories', 'grade': 'B', 'score': 65},
            {'course': 'BUS101', 'unit': 3, 'branch': 'Mathematics', 'grade': 'B', 'score': 80}
        ],
        '100 level Rain': [
            {'course': 'ACC102', 'unit': 3, 'branch': 'Accessories', 'grade': 'A', 'score': 74},
            {'course': 'ECO112', 'unit': 2, 'branch': 'Mathematics', 'grade': 'A', 'score': 70}
        ]
    }
    ...
    # Expected result for branch semester average scores
    ...
    # Calculate branch semester average scores
